...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None):
    if data_source == 'openai/gsm8k':
        ...
        #data_source in ['rag','slidevqa_test', 'mmlongdoc', 'vidoseek', 'slidevqa', 'mmdocbench_level1', "mmdocbench_level2", "mmdocbench_level3", "mmdocbench_level4", "mmdocbench_level5", "mmdocbench_level6"]:
        from . import vrag
