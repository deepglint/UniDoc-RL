...
def mineru_parse_doc(input_image_path, output_dir, backend="pipeline", server_url=None):
    parse_doc(input_image_path, output_dir, backend=backend, lang="en", server_url=server_url, start_page_id=0, end_page_id=0)

# if __name__ == '__main__':
#     input_image_path = ['/workspace/shuotan/datasets/mmrag/data/dude_loader/dude_loader_imgs/c1414e5a4a5b1f8dab0fb2389505af94_0.jpg']
#     output_dir = './layout_output_vis'
#     mineru_parse_doc(input_image_path, output_dir, backend="vlm-http-client", server_url="http://127.0.0.1:30000")
    # args
