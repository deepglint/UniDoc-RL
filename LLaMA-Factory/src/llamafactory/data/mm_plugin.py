...
class MMPluginMixin:
    ...
    def _preprocess_image(
        self, image: "ImageObject", image_max_pixels=512*28*28, image_min_pixels=256*28*28, **kwargs
    ) -> "ImageObject":
        r"""Pre-process a single image."""
        #print("Pre-process a single image.")  #512*512 24*24
        # print(image_max_pixels)
        # print(image_min_pixels)
        # print("===================================")
